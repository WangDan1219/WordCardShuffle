...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  study: 'bg-study text-white hover:bg-study-dark focus:ring-study',
  quiz: 'bg-quiz text-white hover:bg-quiz-dark focus:ring-quiz',
  challenge: 'bg-challenge text-white hover:bg-challenge-dark focus:ring-challenge',
